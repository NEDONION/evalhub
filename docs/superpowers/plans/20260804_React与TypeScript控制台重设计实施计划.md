...
- `README.md`, `docs/getting-started/20260804_本地运行指南.md`: React development and production run instructions.
...
```bash
git add src/evalhub/server.py tests/test_server_frontend.py scripts/start_local.sh README.md docs/getting-started/20260804_本地运行指南.md
