...
```bash
git add README.md docs/getting-started/20260804_本地运行指南.md docs/architecture/20260804_API接口草案.md docs/architecture/20260804_数据模型.md docs/architecture/20260804_系统架构.md tests/test_scheduler_restart.py
